...
<br><br>
<h1> iTech Progress Report</h1>
<p>Report Date: <span id='date-time'></span>.</p>
<script>
var dt = new Date();
...
$sql = "SELECT earnedOCP.date, Standards.standardID, Standards.standardDesc, levels.levelID, levels.levelDescription FROM Standards JOIN assignments ON assignments.standardID=Standards.standardID JOIN levels ON levels.levelID=assignments.levelID INNER JOIN earnedOCP ON assignments.assignmentID=earnedOCP.assignmentID WHERE stuID='$selected'BY standardID ASC";
