...
<body>
<h4> ENTER YOUR STUDENT NUMBER TO SEE YOUR PROGRESS</h4>
<form action="" method="post">

<input type="text" text name="$stuID" id="$stuID">


    <?php
$selected=$GET['$selected'];
include ("conn.php");  //SQL connector
//include ("observe.php");  //Variable passthru from observe
...
<br> 
<br> 
Don't know your student number?  <a href="lookupstudent.php"> Look it up here.</a>
<br> 
<br> 
<br> 
